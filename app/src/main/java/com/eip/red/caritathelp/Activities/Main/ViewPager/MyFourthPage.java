...
public class MyFourthPage extends Fragment {
...
//        newsList = ((MainActivity) getActivity()).getModelManager().getNewsList();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return (inflater.inflate(R.layout.fragment_view_pager_fourth_page, container, false));
    }
    ...
    private void initFragment() {
        ...
        if (fragment != null)
            ...
            Tools.replaceView(this, SubMenuView.newInstance(), Animation.FADE_IN_OUT, true);
    }
